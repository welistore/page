			 ...
			 <ul>
				...
				<li class="published">				
					<time pubdate="<?php echo JHtml::_('date', $this->item->publish_up, JText::_(DATE_W3C)); ?>" itemprop="datePublished">
						<?php echo JHtml::_('date', $this->item->publish_up, JText::_('TPL_GK_STOREBOX_DATE_FORMAT')); ?>
					</time>
				</li>
				...
				<li class="modified">
					<time pubdate="<?php echo JHtml::_('date', $this->item->modified, JText::_(DATE_W3C)); ?>"  itemprop="dateModified">
						<?php echo JHtml::_('date', $this->item->modified, JText::_('TPL_GK_STOREBOX_DATE_FORMAT')); ?>
					</time>
				</li>
				<?php elseif ($params->get('show_create_date')) : ?>
				<li class="created">
					<time pubdate="<?php echo JHtml::_('date', $this->item->created, DATE_W3C); ?>"  itemprop="dateCreated">
						<?php echo JHtml::_('date', $this->item->created, JText::_('TPL_GK_STOREBOX_DATE_FORMAT')); ?>
					</time>
				</li>
				<?php endif; ?>
