...
class K2StoreModelShipping extends K2StoreModelBase
{
    ...
    public function getList($refresh = false)
    {
        ...
        foreach(@$list as $item)
        {
            ...
            $item->link = 'index.php?option=com_k2store&view=shipping&task=view&id='.$item->id;
            $item->link_edit = 'index.php?option=com_k2store&view=shipping&task=edit&id='.$item->id;
