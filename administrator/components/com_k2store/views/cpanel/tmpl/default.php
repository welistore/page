...
<?php if(isset($this->store->store_id) && empty($this->store->config_currency) ):?>
<div class="alert alert-block alert-danger">
<?php echo JText::_('K2STORE_DEFAULT_CURRENCY_NOT_SET'); ?>
</div>
<?php endif; ?>
<div class="alert alert-block alert-info">
<?php echo JText::_('K2STORE_UPDATE_ALL_PLUGINS_ALERT'); ?>
</div>
