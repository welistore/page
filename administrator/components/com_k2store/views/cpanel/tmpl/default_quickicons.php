...
<div class="icon-wrapper">
    <div class="icon">
	    <a href="index.php?option=com_k2store&amp;view=shipping">
...
<div class="icon-wrapper">
    <div class="icon">
	    <a target="_blank" href="http://k2store.org/support/user-guide.html" title="<?php echo JText::_('K2STORE_DOCUMENTATION'); ?>">
		    <img alt="<?php echo JText::_('K2STORE_DOCUMENTATION'); ?>" src="<?php echo JURI::root();?>media/k2store/images/dashboard/documentation.png" />
		    <span><?php echo JText::_('K2STORE_DOCUMENTATION'); ?></span>
	    </a>
    </div>
  </div>
