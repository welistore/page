...
$action = JRoute::_('index.php?option=com_k2store&view=length');
...
<form action="<?php echo $action; ?>" method="post" name="adminForm"
	...
	<fieldset class="fieldset">
			<legend>
				<?php echo JText::_('K2STORE_LENGTHS'); ?>
			</legend>
			<table>
				<tr>
					...
					<small class="muted"><?php echo JText::_('K2STORE_LENGTH_TITLE_DESC')?></small>
					</td>
				</tr>
				...
				<tr>
					...
					<small class="muted"><?php echo JText::_('K2STORE_LENGTH_UNIT_DESC')?></small>
					</td>
				</tr>
				...
				<tr>
					...
					<small class="muted"><?php echo JText::_('K2STORE_LENGTH_VALUE_DESC')?></small>
					</td>
				</tr>
